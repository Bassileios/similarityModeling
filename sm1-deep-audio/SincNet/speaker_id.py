...
import sys
import numpy as np
from helpers.dnn_models import MLP, flip
from helpers.dnn_models import SincNet as CNN
from helpers.data_io import read_conf, str_to_bool
...
def create_batches_rnd(batch_size, data_folder, wav_lst, N_snt, wlen, lab_dict, fact_amp):
    ...
    for i in range(batch_size):
        ...
        print(data_folder + wav_lst[snt_id_arr[i]])
